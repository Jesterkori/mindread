...
export const CATEGORIES = [
  ...
  },
  {
    ...
    ageRange: 'All ages',
    icon: '🌱',
    description: 'For those going through or after a separation',
  ...
  },
  {
    ...
    ageRange: 'All ages',
    icon: '👩‍👧',
    description: 'For single mothers navigating the unique stressors of solo parenting',
  ...
  },
  {
    ...
    ageRange: 'All ages',
    icon: '👨‍👦',
    description: 'For single fathers navigating the unique pressures of solo fatherhood',
