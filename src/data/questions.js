...
const counselling10thQuestions = [
  ...
  { id:1,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'Do you naturally enjoy solving hard math questions and working with numbers?', indicator:'Assesses numerical aptitude and comfort with quantitative data (Core for PCM/Engineering).', reversed:false, safetyQuestion:false },
  { id:2,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'Do you naturally find yourself asking "how does this work?" when looking at machines, gadgets, or physical structures?', indicator:'Indicates scientific curiosity and mechanical aptitude.', reversed:false, safetyQuestion:false },
  { id:3,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'How much do you like doing science experiments and following specific steps to test an idea?', indicator:'Evaluates systematic thinking and interest in research/laboratory environments.', reversed:false, safetyQuestion:false },
  { id:4,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'How frequently do you look for logical patterns and factual evidence before agreeing with an idea?', indicator:'Strong critical thinking and analytical reasoning skills.', reversed:false, safetyQuestion:false },
  { id:5,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'Do you find it interesting to study biology and understand the inner workings of the human body?', indicator:'High interest in life sciences, biology, or medical fields (PCB).', reversed:false, safetyQuestion:false },
  { id:6,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'How much do you like learning about space, physics, and how the universe works?', indicator:'Abstract scientific thinking and conceptual physics aptitude.', reversed:false, safetyQuestion:false },
  { id:7,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'Do you usually handle difficult problems by breaking them down into smaller, easier steps?', indicator:'Algorithmic thinking, crucial for computer science and engineering.', reversed:false, safetyQuestion:false },
  { id:8,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'How much do you like looking at charts, graphs, or data to figure out what they mean?', indicator:'Data literacy and interest in economics or data science.', reversed:false, safetyQuestion:false },
  { id:9,  part:'Part 1: Analytical, Logical & Scientific Thinking', text:'How often do you watch videos or read about new discoveries in science?', indicator:'Intrinsic motivation for continuous learning in STEM fields.', reversed:false, safetyQuestion:false },
  { id:10, part:'Part 1: Analytical, Logical & Scientific Thinking', text:'How much do you prefer subjects that have one correct answer instead of relying on personal opinions?', indicator:'Preference for objective sciences over humanities.', reversed:false, safetyQuestion:false },
  // Part 2: Creativity, Expression & Humanities (Arts / Design / Literature) — Q11–20
  { id:11, part:'Part 2: Creativity, Expression & Humanities', text:'How much do you like writing stories, poems, or keeping a personal journal?', indicator:'High verbal linguistic intelligence and potential for literature, journalism, or content creation.', reversed:false, safetyQuestion:false },
  { id:12, part:'Part 2: Creativity, Expression & Humanities', text:'How often do you enjoy drawing, painting, or creating visual art?', indicator:'Visual-spatial intelligence, pointing toward fine arts, graphic design, or architecture.', reversed:false, safetyQuestion:false },
  { id:13, part:'Part 2: Creativity, Expression & Humanities', text:'How often do you enjoy reading about history, ancient civilizations, or how human societies evolved?', indicator:'Deep interest in humanities, history, and anthropology.', reversed:false, safetyQuestion:false },
  { id:14, part:'Part 2: Creativity, Expression & Humanities', text:'How frequently do you participate in or enjoy performing arts (theater, music, dance)?', indicator:'Expressive creativity and comfort in front of audiences.', reversed:false, safetyQuestion:false },
  { id:15, part:'Part 2: Creativity, Expression & Humanities', text:'How often do you find yourself analyzing the underlying themes in movies, books, or art?', indicator:'Critical media analysis and strong abstract reasoning.', reversed:false, safetyQuestion:false },
  { id:16, part:'Part 2: Creativity, Expression & Humanities', text:'When given a project, how often do you focus heavily on making it look aesthetically pleasing?', indicator:'Design-oriented thinking and attention to visual detail.', reversed:false, safetyQuestion:false },
  { id:17, part:'Part 2: Creativity, Expression & Humanities', text:'How much do you enjoy debating philosophical ideas or discussing "what if" scenarios?', indicator:'Abstract philosophical thinking, suited for law, philosophy, or political science.', reversed:false, safetyQuestion:false },
  { id:18, part:'Part 2: Creativity, Expression & Humanities', text:'How regularly do you come up with unconventional, out-of-the-box ideas that surprise others?', indicator:'Divergent thinking, highly valued in creative industries and advertising.', reversed:false, safetyQuestion:false },
  { id:19, part:'Part 2: Creativity, Expression & Humanities', text:'How often do you enjoy learning new languages or exploring foreign cultures?', indicator:'Linguistic aptitude and potential for international relations or translation.', reversed:false, safetyQuestion:false },
  { id:20, part:'Part 2: Creativity, Expression & Humanities', text:'How frequently do you prefer assignments where there is no single right answer, just your interpretation?', indicator:'Comfort with ambiguity, a core trait of Arts and Humanities students.', reversed:false, safetyQuestion:false },
  // Part 3: Leadership, Business & Communication (Commerce / Management) — Q21–30
  { id:21, part:'Part 3: Leadership, Business & Communication', text:'How often do you naturally take charge when placed in a group project or team activity?', indicator:'Leadership aptitude and willingness to take responsibility.', reversed:false, safetyQuestion:false },
  { id:22, part:'Part 3: Leadership, Business & Communication', text:'How regularly do you find yourself interested in how businesses make money or how the economy works?', indicator:'Commercial awareness and interest in finance, business, or economics.', reversed:false, safetyQuestion:false },
  { id:23, part:'Part 3: Leadership, Business & Communication', text:'How much do you enjoy organizing events, planning schedules, or managing logistics?', indicator:'High organizational skills and project management potential.', reversed:false, safetyQuestion:false },
  { id:24, part:'Part 3: Leadership, Business & Communication', text:'How often are you able to confidently persuade others to see your point of view?', indicator:'Strong negotiation and persuasive communication skills (Sales, Law, Management).', reversed:false, safetyQuestion:false },
  { id:25, part:'Part 3: Leadership, Business & Communication', text:'How frequently do you follow news about startups, stock markets, or famous entrepreneurs?', indicator:'Intrinsic motivation for entrepreneurship and commerce.', reversed:false, safetyQuestion:false },
  { id:26, part:'Part 3: Leadership, Business & Communication', text:'How often do you enjoy managing a budget, saving money, or calculating costs for activities?', indicator:'Financial literacy and potential for accounting or finance roles.', reversed:false, safetyQuestion:false },
  { id:27, part:'Part 3: Leadership, Business & Communication', text:'How comfortable are you with presenting information or speaking in front of a large class?', indicator:'Public speaking confidence and executive presence.', reversed:false, safetyQuestion:false },
  { id:28, part:'Part 3: Leadership, Business & Communication', text:'How regularly do you mediate conflicts between friends and help them find a compromise?', indicator:'Diplomacy and human resource management skills.', reversed:false, safetyQuestion:false },
  { id:29, part:'Part 3: Leadership, Business & Communication', text:'How often do you focus on the most efficient way to get a job done to save time and resources?', indicator:'Operational thinking and business efficiency.', reversed:false, safetyQuestion:false },
  { id:30, part:'Part 3: Leadership, Business & Communication', text:'How much do you value networking and building a wide circle of contacts and friends?', indicator:'Interpersonal intelligence, crucial for business development and PR.', reversed:false, safetyQuestion:false },
  // Part 4: Empathy, Society & Healthcare (Social Sciences / Care / Medicine) — Q31–40
  { id:31, part:'Part 4: Empathy, Society & Healthcare', text:'How often do friends come to you for advice because you are a good listener?', indicator:'High emotional intelligence (EQ) and active listening skills (Psychology, Counseling).', reversed:false, safetyQuestion:false },
  { id:32, part:'Part 4: Empathy, Society & Healthcare', text:'How much do you care about solving social injustices or helping underprivileged communities?', indicator:'Civic-mindedness and passion for social work, NGO work, or public policy.', reversed:false, safetyQuestion:false },
  { id:33, part:'Part 4: Empathy, Society & Healthcare', text:'How frequently do you feel a strong desire to care for people or animals when they are sick?', indicator:'Caregiving aptitude, pointing toward nursing, medicine, or veterinary sciences.', reversed:false, safetyQuestion:false },
  { id:34, part:'Part 4: Empathy, Society & Healthcare', text:'How often do you try to understand why people behave the way they do psychologically?', indicator:'Strong interest in human behavior and psychology.', reversed:false, safetyQuestion:false },
  { id:35, part:'Part 4: Empathy, Society & Healthcare', text:'How comfortable are you remaining calm and helping others during stressful or emergency situations?', indicator:'Crisis management skills, essential for emergency medicine or first responders.', reversed:false, safetyQuestion:false },
  { id:36, part:'Part 4: Empathy, Society & Healthcare', text:'How regularly do you volunteer your time to help teach or mentor younger students?', indicator:'Patience and aptitude for the education and teaching sectors.', reversed:false, safetyQuestion:false },
  { id:37, part:'Part 4: Empathy, Society & Healthcare', text:'How often do you put the needs of the group or others ahead of your own personal goals?', indicator:'High empathy and collaborative spirit.', reversed:false, safetyQuestion:false },
  { id:38, part:'Part 4: Empathy, Society & Healthcare', text:'How much do you enjoy studying the laws, rights, and civic duties of citizens?', indicator:'Interest in civics, public administration, and constitutional law.', reversed:false, safetyQuestion:false },
  { id:39, part:'Part 4: Empathy, Society & Healthcare', text:'How often do you feel deeply affected by the emotions and moods of the people around you?', indicator:'High emotional resonance, common in strong counselors and therapists.', reversed:false, safetyQuestion:false },
  { id:40, part:'Part 4: Empathy, Society & Healthcare', text:'How frequently do you desire a career where the primary goal is helping others rather than making money?', indicator:'Value alignment with non-profit, healthcare, or public service sectors.', reversed:false, safetyQuestion:false },
  // Part 5: Technology, Practical & Hands-On (IT / Vocational / Engineering) — Q41–50
  { id:41, part:'Part 5: Technology, Practical & Hands-On', text:'How often do you enjoy taking things apart (like electronics or gadgets) to see how they work?', indicator:'Reverse-engineering skills and mechanical/hardware aptitude.', reversed:false, safetyQuestion:false },
  { id:42, part:'Part 5: Technology, Practical & Hands-On', text:'How regularly do you code, build websites, or explore how software applications are built?', indicator:'Computational thinking and affinity for Information Technology (IT).', reversed:false, safetyQuestion:false },
  { id:43, part:'Part 5: Technology, Practical & Hands-On', text:'How much do you prefer physical, hands-on work over sitting at a desk reading textbooks?', indicator:'Kinesthetic learning style, pointing toward vocational trades, mechanics, or applied engineering.', reversed:false, safetyQuestion:false },
  { id:44, part:'Part 5: Technology, Practical & Hands-On', text:'How frequently do you build things with your hands (woodworking, robotics, models, crafts)?', indicator:'Spatial reasoning and practical construction skills.', reversed:false, safetyQuestion:false },
  { id:45, part:'Part 5: Technology, Practical & Hands-On', text:'How often do you become the "tech support" person for your family when devices break?', indicator:'Intuitive understanding of modern technology and troubleshooting.', reversed:false, safetyQuestion:false },
  { id:46, part:'Part 5: Technology, Practical & Hands-On', text:'How comfortable are you spending hours focused on a computer screen solving technical errors?', indicator:'High digital tolerance and debugging resilience.', reversed:false, safetyQuestion:false },
  { id:47, part:'Part 5: Technology, Practical & Hands-On', text:'How regularly do you follow the latest trends in Artificial Intelligence, gaming, or cybersecurity?', indicator:'Forward-looking interest in emerging tech sectors.', reversed:false, safetyQuestion:false },
  { id:48, part:'Part 5: Technology, Practical & Hands-On', text:'How often do you enjoy using specialized tools, machinery, or complex equipment?', indicator:'Comfort with industrial or specialized technical environments.', reversed:false, safetyQuestion:false },
  { id:49, part:'Part 5: Technology, Practical & Hands-On', text:'How much do you enjoy designing digital media like 3D models, video edits, or digital music?', indicator:'Blend of technical and creative skills (UI/UX, multimedia arts).', reversed:false, safetyQuestion:false },
  { id:50, part:'Part 5: Technology, Practical & Hands-On', text:'How frequently do you prefer learning by "trial and error" rather than reading the instruction manual?', indicator:'Experiential learning style, highly suited for fast-paced tech and vocational fields.', reversed:false, safetyQuestion:false },
]
...
const counselling12thQuestions = [
  ...
  { id:1,  part:'Part 1: Research, Analytics & Deep Tech', text:'How often do you seek to understand the complex mathematical algorithms behind everyday technology?', indicator:'Assesses advanced quantitative aptitude and interest in computer science or data analytics.', reversed:false, safetyQuestion:false },
  { id:2,  part:'Part 1: Research, Analytics & Deep Tech', text:'How regularly do you read scientific journals, tech blogs, or articles about quantum physics and space exploration?', indicator:'Indicates deep scientific curiosity suited for pure sciences or research.', reversed:false, safetyQuestion:false },
  { id:3,  part:'Part 1: Research, Analytics & Deep Tech', text:'How much do you enjoy taking a massive set of disorganized data and finding clear trends or patterns within it?', indicator:'Evaluates data literacy and aptitude for statistics or financial engineering.', reversed:false, safetyQuestion:false },
  { id:4,  part:'Part 1: Research, Analytics & Deep Tech', text:'How frequently do you approach arguments by demanding empirical evidence and peer-reviewed facts?', indicator:'Strong objective reasoning, essential for scientific and technical fields.', reversed:false, safetyQuestion:false },
  { id:5,  part:'Part 1: Research, Analytics & Deep Tech', text:'How often do you write code, automate simple tasks on your computer, or build basic software/hardware projects?', indicator:'Practical affinity for software engineering and IT development.', reversed:false, safetyQuestion:false },
  { id:6,  part:'Part 1: Research, Analytics & Deep Tech', text:'How much do you enjoy studying the microscopic details of biology, genetics, or organic chemistry?', indicator:'High interest in biotechnology, pharmacology, or advanced life sciences.', reversed:false, safetyQuestion:false },
  { id:7,  part:'Part 1: Research, Analytics & Deep Tech', text:'When a machine or device breaks, how often is your first instinct to dismantle it to find the root mechanical failure?', indicator:'Mechanical engineering and hardware troubleshooting aptitude.', reversed:false, safetyQuestion:false },
  { id:8,  part:'Part 1: Research, Analytics & Deep Tech', text:'How often do you enjoy solving high-level calculus or physics problems that require multiple steps to complete?', indicator:'Tolerance for rigorous, long-form analytical problem-solving.', reversed:false, safetyQuestion:false },
  { id:9,  part:'Part 1: Research, Analytics & Deep Tech', text:'How frequently do you think about how sustainable energy or new materials can solve global environmental issues?', indicator:'Interest in environmental engineering and sustainable technology.', reversed:false, safetyQuestion:false },
  { id:10, part:'Part 1: Research, Analytics & Deep Tech', text:'How often do you prefer working independently in a quiet environment to focus on deeply complex tasks?', indicator:'Comfort with the isolated focus required in research and development roles.', reversed:false, safetyQuestion:false },
  // Part 2: Creativity, Design & Media (Architecture / Fine Arts / Media) — Q11–20
  { id:11, part:'Part 2: Creativity, Design & Media', text:'How often do you find yourself critiquing the typography, color palette, or layout of apps and websites?', indicator:'High visual-spatial intelligence and UI/UX design aptitude.', reversed:false, safetyQuestion:false },
  { id:12, part:'Part 2: Creativity, Design & Media', text:'How regularly do you produce original creative content like short films, digital art, or creative writing?', indicator:'Drive for media production, journalism, or digital arts.', reversed:false, safetyQuestion:false },
  { id:13, part:'Part 2: Creativity, Design & Media', text:'How much do you enjoy studying how physical spaces affect human emotion and behavior?', indicator:'Spatial reasoning suited for architecture or interior design.', reversed:false, safetyQuestion:false },
  { id:14, part:'Part 2: Creativity, Design & Media', text:'How frequently do you follow fashion trends, industrial design, or modern art movements?', indicator:'Intrinsic motivation for aesthetics and commercial design.', reversed:false, safetyQuestion:false },
  { id:15, part:'Part 2: Creativity, Design & Media', text:'How often do you use storytelling (written, spoken, or visual) to convince people of your ideas?', indicator:'Strong narrative skills, highly valued in advertising, marketing, and filmmaking.', reversed:false, safetyQuestion:false },
  { id:16, part:'Part 2: Creativity, Design & Media', text:'When faced with a project, how often do you prioritize making the final product beautiful and emotionally engaging?', indicator:'Design-oriented thinking over pure utilitarianism.', reversed:false, safetyQuestion:false },
  { id:17, part:'Part 2: Creativity, Design & Media', text:'How much do you enjoy editing audio, manipulating photos, or using creative software like Adobe Creative Cloud?', indicator:'Technical proficiency in digital media tools.', reversed:false, safetyQuestion:false },
  { id:18, part:'Part 2: Creativity, Design & Media', text:'How regularly do you come up with unconventional solutions that challenge traditional rules and norms?', indicator:'Divergent thinking, a core trait of successful creatives and innovators.', reversed:false, safetyQuestion:false },
  { id:19, part:'Part 2: Creativity, Design & Media', text:'How often do you observe human behavior to understand what kind of entertainment or art they would consume?', indicator:'Insight into consumer psychology for mass media and entertainment.', reversed:false, safetyQuestion:false },
  { id:20, part:'Part 2: Creativity, Design & Media', text:'How frequently do you prefer assignments that allow you complete creative freedom over strict, rule-based rubrics?', indicator:'Comfort with creative ambiguity and self-directed projects.', reversed:false, safetyQuestion:false },
  // Part 3: Enterprise, Finance & Strategy (Management / Commerce / Law) — Q21–30
  { id:21, part:'Part 3: Enterprise, Finance & Strategy', text:'How often do you analyze how global events (like politics or wars) impact the stock market and local economy?', indicator:'Macro-economic awareness and interest in global finance.', reversed:false, safetyQuestion:false },
  { id:22, part:'Part 3: Enterprise, Finance & Strategy', text:'How regularly do you take the lead in organizing school events, managing the budget, and delegating tasks?', indicator:'Executive leadership, project management, and operational aptitude.', reversed:false, safetyQuestion:false },
  { id:23, part:'Part 3: Enterprise, Finance & Strategy', text:'How much do you enjoy reading about corporate mergers, startup funding, or the success stories of billionaires?', indicator:'Commercial drive and interest in corporate strategy or entrepreneurship.', reversed:false, safetyQuestion:false },
  { id:24, part:'Part 3: Enterprise, Finance & Strategy', text:'How often are you able to negotiate a better deal for yourself, whether buying something or arguing for a grade?', indicator:'Strong negotiation, persuasion, and sales skills.', reversed:false, safetyQuestion:false },
  { id:25, part:'Part 3: Enterprise, Finance & Strategy', text:'How frequently do you track your personal finances, investments, or enjoy studying accounting principles?', indicator:'High financial literacy, pointing toward Chartered Accountancy (CA) or investment banking.', reversed:false, safetyQuestion:false },
  { id:26, part:'Part 3: Enterprise, Finance & Strategy', text:'How often do you enjoy debating corporate ethics, business laws, or intellectual property rights?', indicator:'Analytical thinking suited for corporate law or business administration.', reversed:false, safetyQuestion:false },
  { id:27, part:'Part 3: Enterprise, Finance & Strategy', text:'How comfortable are you standing in front of a room of adults and pitching a business idea or formal presentation?', indicator:'Executive presence and high-stakes public speaking confidence.', reversed:false, safetyQuestion:false },
  { id:28, part:'Part 3: Enterprise, Finance & Strategy', text:'How regularly do you look for ways to optimize a system to maximize profit or minimize wasted time?', indicator:'Strategic business thinking and operational efficiency.', reversed:false, safetyQuestion:false },
  { id:29, part:'Part 3: Enterprise, Finance & Strategy', text:'How often do you naturally act as the mediator when two groups have a conflict of interest?', indicator:'Diplomacy, crucial for human resources and international business relations.', reversed:false, safetyQuestion:false },
  { id:30, part:'Part 3: Enterprise, Finance & Strategy', text:'How much do you value building a strategic network of contacts who can help you advance your professional goals?', indicator:'Networking acumen and business development focus.', reversed:false, safetyQuestion:false },
  // Part 4: Human Health, Society & Law (Medicine / Psychology / Civil Services) — Q31–40
  { id:31, part:'Part 4: Human Health, Society & Law', text:'How often do you read about human psychology, mental health disorders, or neurological functions?', indicator:'Deep interest in clinical psychology, psychiatry, or counseling.', reversed:false, safetyQuestion:false },
  { id:32, part:'Part 4: Human Health, Society & Law', text:'How much do you care about studying the legal system to protect human rights or fight social injustice?', indicator:'Passion for constitutional law, human rights advocacy, or NGO leadership.', reversed:false, safetyQuestion:false },
  { id:33, part:'Part 4: Human Health, Society & Law', text:'How frequently do you feel a strong calling to work in a hospital environment, despite the high stress and long hours?', indicator:'High resilience and dedication required for medicine, nursing, or surgery.', reversed:false, safetyQuestion:false },
  { id:34, part:'Part 4: Human Health, Society & Law', text:'How often do you analyze the root causes of poverty, crime, or educational inequality in your country?', indicator:'Civic-mindedness and aptitude for sociology or public administration (Civil Services).', reversed:false, safetyQuestion:false },
  { id:35, part:'Part 4: Human Health, Society & Law', text:'How comfortable are you handling blood, injuries, or being the first responder in a medical emergency?', indicator:'Clinical detachment and crisis management, essential for medical fields.', reversed:false, safetyQuestion:false },
  { id:36, part:'Part 4: Human Health, Society & Law', text:'How regularly do you study international relations, geopolitics, or how different governments interact?', indicator:'Interest in political science, foreign service, or diplomacy.', reversed:false, safetyQuestion:false },
  { id:37, part:'Part 4: Human Health, Society & Law', text:'How often do you prioritize understanding a person\'s emotional background before judging their actions?', indicator:'High emotional intelligence (EQ) and empathetic reasoning.', reversed:false, safetyQuestion:false },
  { id:38, part:'Part 4: Human Health, Society & Law', text:'How much do you enjoy studying the anatomy of the human body and how different diseases affect it?', indicator:'Core scientific interest aligned with medical and allied health sciences.', reversed:false, safetyQuestion:false },
  { id:39, part:'Part 4: Human Health, Society & Law', text:'How often do you debate the ethical implications of new laws, medical procedures, or government policies?', indicator:'Bioethics and legal reasoning aptitude.', reversed:false, safetyQuestion:false },
  { id:40, part:'Part 4: Human Health, Society & Law', text:'How frequently do you envision a career where your primary metric of success is the number of lives you have improved?', indicator:'Strong value alignment with public service and healthcare sectors.', reversed:false, safetyQuestion:false },
  // Part 5: Execution, Operations & Applied Skills (Vocational / Aviation / Hospitality) — Q41–50
  { id:41, part:'Part 5: Execution, Operations & Applied Skills', text:'How often do you thrive in fast-paced environments where you have to be constantly on your feet and moving?', indicator:'High physical stamina suited for hospitality, event management, or culinary arts.', reversed:false, safetyQuestion:false },
  { id:42, part:'Part 5: Execution, Operations & Applied Skills', text:'How regularly do you obsess over the perfect execution of a live event, dinner service, or travel itinerary?', indicator:'Precision in operations and logistics management.', reversed:false, safetyQuestion:false },
  { id:43, part:'Part 5: Execution, Operations & Applied Skills', text:'How much do you prefer practical, on-the-job training (like internships or apprenticeships) over sitting in a lecture hall?', indicator:'Experiential learning style, pointing toward applied diplomas or vocational degrees.', reversed:false, safetyQuestion:false },
  { id:44, part:'Part 5: Execution, Operations & Applied Skills', text:'How frequently do you follow the aviation industry, merchant navy, or commercial transportation logistics?', indicator:'Interest in commercial aviation, marine engineering, or global supply chains.', reversed:false, safetyQuestion:false },
  { id:45, part:'Part 5: Execution, Operations & Applied Skills', text:'How often do you enjoy providing exceptional customer service and ensuring people feel welcomed and cared for?', indicator:'High interpersonal warmth, essential for hotel management and tourism.', reversed:false, safetyQuestion:false },
  { id:46, part:'Part 5: Execution, Operations & Applied Skills', text:'How comfortable are you strictly following complex safety protocols and operational checklists without deviation?', indicator:'Rule-adherence and discipline, crucial for aviation (pilots) and heavy machinery operations.', reversed:false, safetyQuestion:false },
  { id:47, part:'Part 5: Execution, Operations & Applied Skills', text:'How regularly do you experiment with culinary techniques, baking, or the science of food preparation?', indicator:'Passion for culinary arts and food technology.', reversed:false, safetyQuestion:false },
  { id:48, part:'Part 5: Execution, Operations & Applied Skills', text:'How often do you enjoy coordinating complex schedules, managing inventory, or organizing large-scale supplies?', indicator:'Supply chain management and operational logistics aptitude.', reversed:false, safetyQuestion:false },
  { id:49, part:'Part 5: Execution, Operations & Applied Skills', text:'How much do you enjoy mastering a specific physical or technical skill until you are the absolute best at it?', indicator:'Drive for specialized mastery (e.g., specialized technicians, chefs, pilots).', reversed:false, safetyQuestion:false },
  { id:50, part:'Part 5: Execution, Operations & Applied Skills', text:'How frequently do you prefer careers that offer immediate, tangible results at the end of the workday over long-term abstract projects?', indicator:'Preference for action-oriented, results-driven professions.', reversed:false, safetyQuestion:false },
]
